...
Added the density to the dataframe
It can be appended back as the dataframes (samples and lixels are not sorted)

If we want to shade the points on the map, we will use samples. 
If we want to shade the lines then we will shade use lixels
